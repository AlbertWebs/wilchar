        ...
        <x-admin.section title="Update Page" description="Modify page content and settings.">
            <form action="{{ route('admin.website.pages.update', $page) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="rounded-xl border border-slate-200 bg-white p-5">
                            ...
                            @if($page->featured_image)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $page->featured_image) }}" alt="{{ $page->title }}" class="h-32 w-full rounded-lg object-cover">
                ...
                <div class="flex items-center justify-between gap-3 border-t border-slate-200 pt-6">
                    <a href="{{ route('admin.website.pages.index') }}" class="text-sm font-semibold text-slate-500 hover:text-slate-700">
                        ← Back to pages
                    </a>
