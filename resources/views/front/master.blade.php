...
<head>
    ...
    <!-- #favicon -->
    <link rel="shortcut icon" href="{{asset('main/assets/images/favicon.png')}}" type="image/x-icon">
    <!-- #title -->
    <title>{{ $settings['meta_title'] ?? 'FINVIEW - Financial Loan Review and Comparison Website Template' }}</title>
    <!-- #keywords -->
    <meta name="keywords" content="{{ $settings['meta_keywords'] ?? 'FINVIEW, Financial Loan, Financial Loan Review and Comparison' }}">
    <!-- #description -->
    <meta name="description" content="{{ $settings['meta_description'] ?? 'FINVIEW HTML5 Template' }}">
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-xl nav-shadow" id="#navbar">
                        <a class="navbar-brand" href="index.html"><img src="{{asset('main/assets/images/logo.png')}}" class="logo" alt="logo"></a>
                    ...
                    <div class="custom-nevbar__right">
                        ...
                        <ul class="custom-nevbar__right-location">
                            <li>
                                ...
                                <a href="tel:{{ str_replace(' ', '', $settings['site_phone'] ?? '+123 456 789') }}" class="fs-4 contact">{{ $settings['site_phone'] ?? '+123 456 789' }}</a>
                            </li>
                            <li class="location">
                                <p class="mb-2">Email: </p>
                                <a href="mailto:{{ $settings['site_email'] ?? 'info@example.com' }}" class="fs-4 contact">{{ $settings['site_email'] ?? 'info@example.com' }}</a>
                            </li>
                            <li class="location">
                                <p class="mb-2">Location: </p>
                                <p class="fs-4 contact">{{ $settings['site_address'] ?? 'Quickmart Plaza, Kakamega' }}</p>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer__contact ms-sm-4 ms-xl-0 wow fadeInUp" data-wow-duration="0.8s">
                        ...
                        <div class="footer__content">
                            <a href="tel:{{ str_replace(' ', '', $settings['site_phone'] ?? '+254704388759') }}"> <span class="btn_theme social_box"> <i class="bi bi-telephone-plus"></i> </span> {{ $settings['site_phone'] ?? '+254 704 388 759' }} <span></span> </a> 
                            <a href="mailto:{{ $settings['site_email'] ?? 'info@nurusmesolution.co.ke' }}"> <span class="btn_theme social_box"> <i class="bi bi-envelope-open"></i> </span> {{ $settings['site_email'] ?? 'info@nurusmesolution.co.ke' }} <span></span> </a> 
                            <a href="#"> <span class="btn_theme social_box"> <i class="bi bi-geo-alt"></i> </span> {{ $settings['site_address'] ?? 'Quickmart Plaza, Kakamega' }} <span></span> </a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl-3">
