...
<head>
    ...
    <style>
        ...
        /* Elegant Payment & Contact Section Styles */
        .payment-contact-card {
            position: relative;
            padding: 3rem 2rem;
            background: linear-gradient(135deg, #ed741b 0%, #ae781a 50%, #cc231b 100%);
            border-radius: 24px;
            box-shadow: 0 20px 60px rgba(237, 116, 27, 0.3);
            overflow: hidden;
            text-align: center;
        ...
        .payment-contact-card:hover {
            ...
            box-shadow: 0 25px 70px rgba(237, 116, 27, 0.4);
        }

        .payment-contact-card__icon-wrapper {
            position: relative;
        ...
        .payment-contact-card__subtitle {
            font-size: 1rem;
        ...
        .payment-contact-card__decorative-elements {
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        .payment-contact-card__circle--1 {
            width: 120px;
            height: 120px;
            top: -30px;
            right: -30px;
        ...
        .payment-contact-card__circle--2 {
            width: 80px;
            height: 80px;
            bottom: -20px;
            left: -20px;
        ...
        .payment-contact-card__circle--3 {
            width: 60px;
            height: 60px;
            top: 50%;
            right: 10%;
        ...
        .contact-info-item:hover {
            ...
            border-color: #ed741b;
            box-shadow: 0 8px 24px rgba(237, 116, 27, 0.15);
        }
        ...
        .contact-info-item--highlight:hover {
            border-color: #d97706;
        ...
        .contact-info-item__icon {
            ...
            align-items: center;
            justify-content: center;
            background: linear-gradient(135deg, #ed741b 0%, #ae781a 100%);
            border-radius: 12px;
            color: #ffffff;
            font-size: 1.25rem;
        ...
        .contact-info-item--highlight .contact-info-item__icon {
        ...
        .contact-info-item__value--paybill {
            font-size: 1.1rem;
            color: #d97706;
            font-weight: 700;
            letter-spacing: 1px;
        ...
        .contact-info-item__payment-details {
            display: flex;
            flex-direction: column;
            gap: 0.5rem;
            margin-top: 0.25rem;
        ...
        .contact-info-item__payment-row {
            display: flex;
            align-items: center;
            gap: 0.5rem;
            flex-wrap: wrap;
        ...
        .contact-info-item__payment-label {
            font-size: 0.75rem;
            font-weight: 600;
            color: #64748b;
            text-transform: uppercase;
        ...
        .contact-info-item__value--account {
            font-size: 0.95rem;
            color: #1e293b;
            font-weight: 600;
                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-xl nav-shadow" id="#navbar">
                        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
                            <img style="border-radius:10px;" width="100" src="<?php echo e(!empty($settings['logo']) ? asset('storage/' . $settings['logo']) : asset('main/assets/images/logo.png')); ?>" class="logo" alt="<?php echo e($settings['site_name'] ?? 'Nuru Wilchar'); ?> Logo">
                        </a>
            ...
            <div class="row section gy-5 gy-xl-0">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="quick-link ms-sm-4 ms-xl-0 wow fadeInRight" data-wow-duration="0.8s">
                        ...
                        <ul>
                            <li><a href="<?php echo e(route('page.show', 'terms-and-conditions')); ?>">Terms and Conditions</a></li>
                            <li><a href="<?php echo e(route('page.show', 'privacy-policy')); ?>">Privacy Policy</a></li>
                            <li><a href="<?php echo e(route('page.show', 'copyright-statement')); ?>">Copyright Statement</a></li>
                            <li><a href="<?php echo e(route('page.show', 'cbk-disclaimer')); ?>">CBK Disclaimer</a></li>
                        </ul>
                    </div>
                </div>
            </div>
