        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8 col-xxl-7">
                <div class="text-center wow fadeInUp" data-wow-duration="0.8s">
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('home')); ?>" class="btn_theme btn_theme_active">
                            Return to Home <i class="bi bi-arrow-left"></i><span></span>
                        </a>
                        <a href="<?php echo e(route('loan-application.create')); ?>" class="btn_theme ms-3">
...
<?php echo $__env->make('front.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\wilchar\resources\views\front\loan-application-thank-you.blade.php ENDPATH**/ ?>