...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.section','data' => ['title' => 'Testimonial Details','description' => 'Add a new client testimonial to display on the home page.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Testimonial Details','description' => 'Add a new client testimonial to display on the home page.']); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="position" value="<?php echo e(old('position')); ?>" class="mt-1 w-full rounded-xl border-slate-200" placeholder="e.g. Business Owner">
                    </div>
                </div>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="company" value="<?php echo e(old('company')); ?>" class="mt-1 w-full rounded-xl border-slate-200" placeholder="e.g. ABC Enterprises">
                    </div>
                    <div>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="5" <?php if(old('rating') == 5): echo 'selected'; endif; ?>>5 Stars - Excellent</option>
                            <option value="4" <?php if(old('rating') == 4): echo 'selected'; endif; ?>>4 Stars - Very Good</option>
                            <option value="3" <?php if(old('rating') == 3): echo 'selected'; endif; ?>>3 Stars - Good</option>
                            <option value="2" <?php if(old('rating') == 2): echo 'selected'; endif; ?>>2 Stars - Fair</option>
                            <option value="1" <?php if(old('rating') == 1): echo 'selected'; endif; ?>>1 Star - Poor</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" required placeholder="Enter the client's testimonial..."><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', ['title' => 'Create Testimonial'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\wilchar\resources\views\admin\testimonials\create.blade.php ENDPATH**/ ?>