    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10 col-xxl-9">
                ...
                <form action="<?php echo e(route('loan-application.store')); ?>" method="POST" enctype="multipart/form-data" id="loanApplicationForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="tel" name="phone" class="form-control" value="<?php echo e(old('phone')); ?>" placeholder="2547XXXXXXXX" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">M-Pesa Phone Number</label>
                                    <input type="tel" name="mpesa_phone" class="form-control" value="<?php echo e(old('mpesa_phone')); ?>" placeholder="2547XXXXXXXX">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Alternate Phone</label>
                                    <input type="tel" name="alternate_phone" class="form-control" value="<?php echo e(old('alternate_phone')); ?>">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="id_number" class="form-control" value="<?php echo e(old('id_number')); ?>" required>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="business_type" class="form-control" required>
                                        ...
                                        <option value="Mama Mboga" <?php echo e(old('business_type') == 'Mama Mboga' ? 'selected' : ''); ?>>Mama Mboga</option>
                                        <option value="Boda Boda" <?php echo e(old('business_type') == 'Boda Boda' ? 'selected' : ''); ?>>Boda Boda</option>
                                        <option value="Tuk-tuk Operator" <?php echo e(old('business_type') == 'Tuk-tuk Operator' ? 'selected' : ''); ?>>Tuk-tuk Operator</option>
                                        <option value="Small Shop" <?php echo e(old('business_type') == 'Small Shop' ? 'selected' : ''); ?>>Small Shop</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="business_location" class="form-control" value="<?php echo e(old('business_location')); ?>" placeholder="Town, Estate, Street" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="loan_product_id" class="form-control" id="loan_product_id">
                                        ...
                                        <?php $__currentLoopData = $loanProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($product->id); ?>" <?php echo e(old('loan_product_id') == $product->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="amount" id="loan_amount" class="form-control" min="1000" step="0.01" value="<?php echo e(old('amount')); ?>" oninput="calculateTotals()" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Duration (Months) <span class="text-danger">*</span></label>
                                    <input type="number" name="duration_months" id="duration_months" class="form-control" min="1" max="120" value="<?php echo e(old('duration_months', 12)); ?>" oninput="calculateTotals()" required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="repayment_frequency" id="repayment_frequency" class="form-control" onchange="applyFrequency()" required>
                                        <?php $__currentLoopData = $repaymentFrequencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $frequency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(old('repayment_frequency', 'monthly') == $key ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="registration_fee" id="registration_fee" class="form-control" min="0" step="0.01" value="<?php echo e(old('registration_fee', 0)); ?>" oninput="calculateTotals()">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="purpose" class="form-control" rows="3" placeholder="Describe how you will use the loan funds..."><?php echo e(old('purpose')); ?></textarea>
                                </div>
                            </div>
                    ...
                    <div class="text-center mb-5 wow fadeInUp" data-wow-duration="0.8s">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="btn_theme ms-3">
                            Cancel
                        </a>
                    </div>
                </form>
...
<script>
const frequencyOptions = <?php echo json_encode(collect($repaymentFrequencies)->map(fn($freq, $key) => array_merge($freq, ['key' => $key]))->values()) ?>;
...
<?php echo $__env->make('front.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\wilchar\resources\views\front\loan-application-form.blade.php ENDPATH**/ ?>