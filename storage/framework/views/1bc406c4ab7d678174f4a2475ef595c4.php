                            ...
                            <tr class="hover:bg-slate-50/80">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="inline-flex items-center gap-2">
                                        <a href="<?php echo e(route('clients.show', $client)); ?>" class="rounded-xl border border-slate-200 px-3 py-1 text-xs font-semibold text-slate-600 hover:bg-slate-50">
                                            View
                                        </a>
                                        <a href="<?php echo e(route('clients.edit', $client)); ?>" class="rounded-xl border border-slate-200 px-3 py-1 text-xs font-semibold text-slate-600 hover:bg-slate-50">
                                            Edit
                                        </a>
                                    </div>
                                </td>
...
<?php echo $__env->make('layouts.admin', ['title' => 'Clients'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\wilchar\resources\views/admin/clients/index.blade.php ENDPATH**/ ?>