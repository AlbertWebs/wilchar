                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="mt-4 flex items-center gap-3">
                            ...
                            <?php if($role->name !== 'Admin'): ?>
                                <form
                                    id="delete-role-form-<?php echo e($role->id); ?>"
                                    method="POST"
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        onclick="(async () => { const ok = await Admin.confirmAction({ title: 'Delete Role?', text: 'This action cannot be undone.', icon: 'warning', confirmButtonText: 'Delete' }); if (ok) document.getElementById('delete-role-form-<?php echo e($role->id); ?>').submit(); })()"
                                    >
                                        Delete
                                    </button>
                                </form>
