...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.section','data' => ['title' => 'Product Details','description' => 'Update the product information.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Product Details','description' => 'Update the product information.']); ?>
            <form action="<?php echo e(route('admin.products.update', $product)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $product->name)); ?>" class="mt-1 w-full rounded-xl border-slate-200 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" value="<?php echo e(old('slug', $product->slug)); ?>" class="mt-1 w-full rounded-xl border-slate-200">
                ...
                <div>
                    ...
                    <input type="text" name="short_description" value="<?php echo e(old('short_description', $product->short_description)); ?>" class="mt-1 w-full rounded-xl border-slate-200" maxlength="500">
                </div>

                <div>
                    <label class="text-xs font-semibold uppercase tracking-wide text-slate-500">Full Description</label>
                    <textarea name="description" rows="5" class="mt-1 w-full rounded-xl border-slate-200"><?php echo e(old('description', $product->description)); ?></textarea>
                </div>

                <div class="grid gap-4 md:grid-cols-3">
                    <div>
                        <label class="text-xs font-semibold uppercase tracking-wide text-slate-500">Interest Rate (%)</label>
                        <input type="number" name="interest_rate" value="<?php echo e(old('interest_rate', $product->interest_rate)); ?>" step="0.01" min="0" max="100" class="mt-1 w-full rounded-xl border-slate-200">
                    </div>
                    <div>
                        <label class="text-xs font-semibold uppercase tracking-wide text-slate-500">Loan Duration</label>
                        <input type="text" name="loan_duration" value="<?php echo e(old('loan_duration', $product->loan_duration)); ?>" class="mt-1 w-full rounded-xl border-slate-200">
                    </div>
                    <div>
                        <label class="text-xs font-semibold uppercase tracking-wide text-slate-500">Display Order</label>
                        <input type="number" name="display_order" value="<?php echo e(old('display_order', $product->display_order)); ?>" min="0" class="mt-1 w-full rounded-xl border-slate-200">
                    </div>
                </div>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="min_amount" value="<?php echo e(old('min_amount', $product->min_amount)); ?>" step="0.01" min="0" class="mt-1 w-full rounded-xl border-slate-200">
                    </div>
                    <div>
                        <label class="text-xs font-semibold uppercase tracking-wide text-slate-500">Maximum Amount (KES)</label>
                        <input type="number" name="max_amount" value="<?php echo e(old('max_amount', $product->max_amount)); ?>" step="0.01" min="0" class="mt-1 w-full rounded-xl border-slate-200">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div id="features-container" class="mt-2 space-y-2">
                        <?php if(old('features', $product->features)): ?>
                            <?php $__currentLoopData = old('features', $product->features); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex gap-2">
                                    <input type="text" name="features[]" value="<?php echo e($feature); ?>" class="flex-1 rounded-xl border-slate-200">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <?php if($product->icon): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $product->icon)); ?>" alt="<?php echo e($product->name); ?>" class="h-16 w-16 rounded object-cover">
                    ...
                    <div>
                        ...
                        <?php if($product->image): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="h-32 w-full rounded object-cover">
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $product->is_active) ? 'checked' : ''); ?> class="h-4 w-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500">
...
<?php echo $__env->make('layouts.admin', ['title' => 'Edit Product'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\wilchar\resources\views\admin\products\edit.blade.php ENDPATH**/ ?>