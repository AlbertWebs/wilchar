...
<head>
    ...
    <link rel="icon" href="<?php echo e($adminPwaIcon); ?>" type="<?php echo e($adminPwaIconType); ?>">
    <meta name="application-name" content="<?php echo e($adminPwaTitle); ?>">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <meta name="apple-mobile-web-app-title" content="<?php echo e($adminPwaTitle); ?>">
    ...
    <link rel="apple-touch-icon" href="<?php echo e($adminPwaIcon); ?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e($adminPwaIcon); ?>">
    
    <link rel="manifest" href="<?php echo e(route('pwa.manifest.admin')); ?>">
        ...
        >
            ...
            <nav class="flex-1 px-4 pb-6">
                ...
                <ul class="mt-3 space-y-1 text-sm">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.legal-pages.index')); ?>"
                           class="group flex items-center gap-3 rounded-lg px-3 py-2 transition hover:bg-slate-800/60 <?php echo e(request()->routeIs('admin.legal-pages.*') ? 'bg-slate-800 text-white' : 'text-slate-300'); ?>">
                            <svg class="h-5 w-5 shrink-0 text-purple-400 group-hover:text-purple-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mpesa.view')): ?>
                        ...
                        <li>
                            <a href="<?php echo e(route('mpesa.c2b.index')); ?>"
                               class="group flex items-center gap-3 rounded-lg px-3 py-2 pl-10 transition hover:bg-slate-800/60 <?php echo e(request()->routeIs('mpesa.c2b.*') && !request()->is('*c2b/register-urls*') ? 'bg-slate-800 text-white' : 'text-slate-300'); ?>">
                        ...
                        <li>
                            <form action="<?php echo e(route('mpesa.c2b.register-urls')); ?>" method="POST" class="inline w-full">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                                   class="group flex w-full items-center gap-3 rounded-lg px-3 py-2 pl-10 transition hover:bg-slate-800/60 text-left <?php echo e(request()->is('*c2b/register-urls*') ? 'bg-slate-800 text-white' : 'text-slate-300'); ?>">
