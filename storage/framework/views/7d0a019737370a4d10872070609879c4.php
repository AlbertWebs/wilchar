...
<form
    x-data="{
        amount: <?php echo e(old('amount', $application->amount ?? 0)); ?>,
        duration: <?php echo e(old('duration_months', $application->duration_months ?? 1)); ?>,
        registrationFee: <?php echo e(old('registration_fee', $application->registration_fee ?? 0)); ?>,
        interestRate: <?php echo e(old('interest_rate', $application->interest_rate ?? 35)); ?>,
        products: <?php echo \Illuminate\Support\Js::from($productOptions)->toHtml() ?>,
        selectedProductId: <?php echo e(old('loan_product_id', $application->loan_product_id ?? 'null')); ?>,
        frequencyOptions: <?php echo \Illuminate\Support\Js::from(collect($repaymentFrequencies)->map(fn($freq, $key) => array_merge($freq, ['key' => $key]))->values())->toHtml() ?>,
        selectedFrequencyKey: '<?php echo e(old('repayment_frequency', $application->repayment_frequency ?? 'monthly')); ?>',
        repaymentIntervalWeeks: <?php echo e(old('repayment_interval_weeks', $application->repayment_interval_weeks ?? 4)); ?>,
        weeklyPayment: <?php echo e(old('weekly_payment_amount', $application->weekly_payment_amount ?? 0)); ?>,
        cyclePayment: <?php echo e(old('repayment_cycle_amount', $application->repayment_cycle_amount ?? 0)); ?>,
        totalInterest: <?php echo e(old('interest_amount', $application->interest_amount ?? 0)); ?>,
        totalRepayment: <?php echo e(old('total_repayment_amount', $application->total_repayment_amount ?? 0)); ?>,
        updateFromProduct() {
                ...
                <div>
                    ...
                    <select name="client_id" class="mt-1 w-full rounded-xl border-slate-200" required>
                        ...
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($client->id); ?>" <?php if(old('client_id', $application->client_id ?? '') == $client->id): echo 'selected'; endif; ?>>
                ...
                <div>
                    ...
                    <select name="team_id" class="mt-1 w-full rounded-xl border-slate-200">
                        ...
                        <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($team->id); ?>" <?php if(old('team_id', $application->team_id ?? '') == $team->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <div class="mt-6 grid gap-4 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <select name="loan_product_id" class="mt-1 w-full rounded-xl border-slate-200" x-model="selectedProductId" @change="updateFromProduct()">
                        ...
                        <?php $__currentLoopData = $loanProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($product->id); ?>" <?php if(old('loan_product_id', $application->loan_product_id ?? '') == $product->id): echo 'selected'; endif; ?>>
                ...
                <div>
                    ...
                    <input type="number" min="1000" step="0.01" name="amount" x-model="amount" @input="calculateTotals()" value="<?php echo e(old('amount', $application->amount ?? '')); ?>" class="mt-1 w-full rounded-xl border-slate-200" required>
                </div>
                <div>
                    <label class="text-sm font-medium text-slate-700">Duration (Months)</label>
                    <input type="number" min="1" name="duration_months" x-model="duration" @input="calculateTotals()" value="<?php echo e(old('duration_months', $application->duration_months ?? 12)); ?>" class="mt-1 w-full rounded-xl border-slate-200" required>
                </div>
                <div>
                    <div class="flex items-center justify-between">
                    ...
                    <select name="repayment_frequency" class="mt-1 w-full rounded-xl border-slate-200 text-sm" x-model="selectedFrequencyKey" @change="applyFrequency()">
                        <?php $__currentLoopData = $repaymentFrequencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $frequency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php if(old('repayment_frequency', $application->repayment_frequency ?? 'monthly') === $key): echo 'selected'; endif; ?>>
                                <?php echo e($frequency['label']); ?>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="interest_rate" x-model="interestRate" value="<?php echo e(old('interest_rate', $application->interest_rate ?? 35)); ?>" class="mt-1 w-full rounded-xl border-slate-200" readonly>
                </div>
                <div>
                    <label class="text-sm font-medium text-slate-700">Registration / Processing Fee (KES)</label>
                    <input type="number" min="0" step="0.01" name="registration_fee" x-model="registrationFee" @input="calculateTotals()" value="<?php echo e(old('registration_fee', $application->registration_fee ?? 0)); ?>" class="mt-1 w-full rounded-xl border-slate-200">
                </div>
            </div>
                ...
                <div class="mt-4 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="collection_officer_id" class="mt-1 w-full rounded-xl border-slate-200">
                            <option value="">Select</option>
                            <?php $__currentLoopData = $collectionOfficers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $officer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($officer->id); ?>" <?php if(old('collection_officer_id', $application->collection_officer_id ?? '') == $officer->id): echo 'selected'; endif; ?>>
                                    <?php echo e($officer->name); ?>
                    ...
                    <div>
                        ...
                        <select name="finance_officer_id" class="mt-1 w-full rounded-xl border-slate-200">
                            <option value="">Select</option>
                            <?php $__currentLoopData = $financeOfficers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $officer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($officer->id); ?>" <?php if(old('finance_officer_id', $application->finance_officer_id ?? '') == $officer->id): echo 'selected'; endif; ?>>
                                    <?php echo e($officer->name); ?>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            <div class="rounded-2xl border border-slate-200 bg-white p-5 lg:col-span-2">
                ...
                <textarea name="purpose" rows="4" class="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50/70 p-4 text-sm text-slate-700 focus:border-emerald-400 focus:ring-emerald-400" placeholder="Describe how the funds will be used, key milestones, repayment sources..."><?php echo e(old('purpose', $application->purpose ?? '')); ?></textarea>
    ...
    <div class="flex items-center justify-end gap-3">
        ...
        <button type="submit" class="rounded-xl bg-emerald-500 px-6 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-400">
            <?php echo e($isEdit ? 'Update Application' : 'Save Application'); ?>

        </button>
    </div>
</form>

<?php /**PATH C:\xampp\htdocs\wilchar\resources\views/admin/loan-applications/partials/form.blade.php ENDPATH**/ ?>